        ...
        <tbody>
            ...
            <tr style="word-break:break-all;">
                ...
                <td style="width:200px">
                    <button class="btn btn-warning btnEditInfo" data-familyinfo='{{ $familyInformation }}' data-url="{{ route('teacher.students.special-students.family-information.update',$familyInformation->id) }}" id="btnEditInfo{{$familyInformation->id}}"><i class="fa fa-pencil"></i></button>
                    <button type="button" class="btn btn-danger"
                                        onclick="event.preventDefault();
                                            ...
                                            document.getElementById('form-delete-{{$familyInformation->id}}').submit()
                                                ...
                                                <form style="display:none" id="{{'form-delete-'.$familyInformation->id}}" method="post" action="{{route('teacher.students.special-students.family-information.destroy',$familyInformation->id)}}">
                                                     @csrf
                                                     @method('delete')
                                                </form>
                </td>
...
<div class="modal fade" id="addInfoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form id="addInfoForm" method="post" action="{{ route('teacher.students.special-students.family-information.store') }}">  
        @csrf
