...
<br>
<form method="post" autocomplete="off" action="{{ route('teacher.students.special-students.developmental-milestone.update',$specialStudent->developmentalMilestone->id) }}">
    @csrf
    @method('put')
    <div class="row">
        <div class="col-sm-6">
