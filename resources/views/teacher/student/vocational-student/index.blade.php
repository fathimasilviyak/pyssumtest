        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('teacher.students.vocational-students.create') }}"  class="btn btn-success" style="display: inline-block; float: right"><i class="fas fa-user-plus"></i> Create Vocational Student</a>
              </div>
                        @if (session('success'))
          ...
          @php ($s_no++)
              @if($user->status == 1)
                    <tr style="word-break:break-all;">
                        ...
                        <a href="{{ route('teacher.students.vocational-students.show', $user->vocationalStudent->id) }}"  class="btn btn-info">Show</a>
                            <!-- <button class="btn btn-warning btnProductUpdate" data-product='' data-url="" id=""><i class="fa fa-pencil"></i></button> -->
                            <a href="{{ route('teacher.students.vocational-students.edit', $user->vocationalStudent->id) }}"  class="btn btn-warning"> <i class="fa fa-pencil"></i> </a>
                            <button type="button" class="btn btn-danger"
                                        onclick="event.preventDefault();
                                            ...
                                            document.getElementById('form-delete-{{$user->id}}').submit()
                                                ...
                                                <form style="display:none" id="{{'form-delete-'.$user->id}}" method="post" action="{{route('teacher.students.vocational-students.destroy',$user->id)}}">
                                                     @csrf
                                                     @method('delete')
                                                </form>
              ...
              <tr style="background-color:#FFE0DC">
                        ...
                        <td>
                            ...
                            <!-- <button class="btn btn-warning btnProductUpdate" data-product='' data-url="" id=""><i class="fa fa-pencil"></i></button> -->
                            <a href="{{ route('teacher.students.vocational-students.complete-create',$user->id) }}"  class="btn btn-warning"> <i class="fa fa-pencil"></i> </a>
                            <button type="button" class="btn btn-danger"
                                        onclick="event.preventDefault();
                                            if(confirm('Are you really want to delete the Vocational Student?')){
                                            document.getElementById('form-delete-{{$user->id}}').submit()
