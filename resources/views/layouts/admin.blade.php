...
<head>
  ...
  <title>Pyssum | Admin Dashboard</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin.students.special-students.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Special Students</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin.students.inclusive-students.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Inclusive Students</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin.students.training-students.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Training Students</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin.students.vocational-students.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="{{ route('admin.early-intervention-registrations.index') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.student-classes.index') }}" class="nav-link">
              <i class="fas fa-th"></i>
              <p>
                Classes
              </p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>Dashboard <small class="text-secondary" style="font-size: 15px;">Admin|</small>
