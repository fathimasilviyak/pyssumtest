        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
<!-- show success or error while faculty register -->
              @if (session('success'))
              ...
              <!-- form start -->
              <form method="post" autocomplete="off" action="{{ route('admin.faculties.store') }}">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="role" name="role" value="teacher">
