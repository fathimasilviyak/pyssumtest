...
<br>
<form method="post" autocomplete="off" action="{{ route('admin.students.special-students.occupational-assessment.update',$specialStudent->occupationalAssessment->id) }}">
    @csrf
    @method('put')
    <div class="row">
        <div class="col-sm-12">
