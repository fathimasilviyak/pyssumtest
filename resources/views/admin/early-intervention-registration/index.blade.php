        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('admin.early-intervention-registrations.create') }}"  class="btn btn-success" style="display: inline-block; float: right"><i class="fas fa-user-plus"></i>Early Intervention Registration</a>
              </div>
                        @if (session('success'))
          ...
          @php ($s_no++)
                    <tr style="word-break:break-all;">
                        ...
                        <a href="{{ route('admin.early-intervention-registrations.show', $eIRegistration->id) }}"  class="btn btn-info">Show</a>
                            <!-- <button class="btn btn-warning btnProductUpdate" data-product='' data-url="" id=""><i class="fa fa-pencil"></i></button> -->
                            <a href="{{ route('admin.early-intervention-registrations.edit', $eIRegistration->id) }}"  class="btn btn-warning"> <i class="fa fa-pencil"></i> </a>
                            <button type="button" class="btn btn-danger"
                                        onclick="event.preventDefault();
                                            ...
                                            document.getElementById('form-delete-{{$eIRegistration->id}}').submit()
                                                ...
                                                <form style="display:none" id="{{'form-delete-'.$eIRegistration->id}}" method="post" action="{{route('admin.early-intervention-registrations.destroy',$eIRegistration->id)}}">
                                                     @csrf
                                                     @method('delete')
                                                </form>
