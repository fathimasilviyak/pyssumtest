                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @php ($s_no++)
                    <tr style="word-break:break-all;">
                        ...
                        <button class="btn btn-warning btnEditClass" data-studentclass='{{ $studentClass }}' data-url="{{ route('admin.student-classes.update',$studentClass->id) }}" id="btnUpdateClass{{$studentClass->id}}"><i class="fa fa-pencil"></i></button>
                        ...
                        <button type="button" class="btn btn-danger"
                                        onclick="event.preventDefault();
                                            ...
                                            document.getElementById('form-delete-{{$studentClass->id}}').submit()
                                                ...
                                                <form style="display:none" id="{{'form-delete-'.$studentClass->id}}" method="post" action="{{route('admin.student-classes.destroy',$studentClass->id)}}">
                                                     @csrf
                                                     @method('delete')
                                                </form>
                        <a class="btn btn-info" href="{{ route('admin.student-classes.class-sections.index',$studentClass->id) }}">Sections</button>
...
<div class="modal fade" id="addClassModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form id="addClassForm" method="post" action="{{ route('admin.student-classes.store') }}">  
    @csrf
