                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @php ($s_no++)
                    <tr style="word-break:break-all;">
                        ...
                        <button class="btn btn-warning btnEditSection" data-classsection='{{ $classSection }}' data-url="{{ route('admin.student-classes.class-sections.update',$classSection->id) }}" id="btnUpdateSection{{$classSection->id}}"><i class="fa fa-pencil"></i></button>
                        <button type="button" class="btn btn-danger"
                                        onclick="event.preventDefault();
                                            ...
                                            document.getElementById('form-delete-{{$classSection->id}}').submit()
                                                ...
                                                <form style="display:none" id="{{'form-delete-'.$classSection->id}}" method="post" action="{{route('admin.student-classes.class-sections.destroy',$classSection->id)}}">
                                                     @csrf
                                                     @method('delete')
                                                </form>
...
<div class="modal fade" id="addSectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form id="addSectionForm" method="post" action="{{ route('admin.student-classes.class-sections.store')}}">  
    @csrf
