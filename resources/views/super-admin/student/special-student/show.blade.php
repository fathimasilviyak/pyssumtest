...
<div class="modal fade" id="selectDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form id="selectDataForm" method="post" action="{{ route('super-admin.students.special-students.generate-pdf',$specialStudent->id) }}">  
    @csrf
