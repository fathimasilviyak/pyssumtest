...
<br>
<form method="post" autocomplete="off" action="{{ route('super-admin.students.special-students.psychological-assessment.update',$specialStudent->psychologicalAssessment->id) }}">
    @csrf
    @method('put')
    <div class="row">
        <div class="col-sm-6">
