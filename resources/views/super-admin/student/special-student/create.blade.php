          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Register special_student</h3>
              </div>
              <!-- /.card-header -->
<!-- show success or error while Special Student register -->
              @if (session('success'))
              ...
              <!-- form start -->
              <form method="post" autocomplete="off" action="{{ route('super-admin.students.special-students.store') }}">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="role" name="role" value="special_student">
