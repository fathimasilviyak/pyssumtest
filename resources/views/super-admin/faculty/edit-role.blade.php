        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form method="post" autocomplete="off" action="{{ route('super-admin.faculties.update-role', $faculty->id) }}">
                  @csrf
                  @method('put')
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="role" name="role" required>
                            ...
                            <option value="super_admin" {{ $faculty->user->role == 'super_admin' ? 'selected' : '' }} >super_admin</option>
