...
<div class="container-fluid">
    <div class="d-flex justify-content-end mb-4">
      <a class="btn btn-info" href="{{ route('super-admin.faculties.generate-pdf',$faculty->id) }}"><i class="fas fa-file-pdf"></i>Export to PDF</a>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>role</td>
                            <td>{{ $faculty->user->role }}<a href="{{ route('super-admin.faculties.edit-role', $faculty->id) }}"  class="btn btn-info"  style="display: inline-block; float: right">Change role?</a></td>
                        </tr> 
