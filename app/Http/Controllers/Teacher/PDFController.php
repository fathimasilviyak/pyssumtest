...
class PDFController extends Controller
{
    ...
    public function generateSpecialStudentPDF(Request $request, SpecialStudent $specialStudent){
        ...
        $pdf = PDF::loadView('teacher.student.special-student.pdf', compact('specialStudent','selectedData'));
    ...
    public function generateInclusiveStudentPDF(InclusiveStudent $inclusiveStudent){
        ...
        $pdf = PDF::loadView('teacher.student.inclusive-student.pdf', compact('inclusiveStudent'));
    ...
    public function generateVocationalStudentPDF(VocationalStudent $vocationalStudent){
        ...
        $pdf = PDF::loadView('teacher.student.vocational-student.pdf', compact('vocationalStudent'));
    ...
    public function generateTrainingStudentPDF(TrainingStudent $trainingStudent){
        ...
        $pdf = PDF::loadView('teacher.student.training-student.pdf', compact('trainingStudent'));
