...
class SpecialStudentController extends Controller
{
    ...
    public function index(){
        ...
        $users = User::where('role', 'special_student')
         ...
         return view('teacher.student.special-student.index',compact('users'));
    ...
    public function show(SpecialStudent $specialStudent){
        ...
        return view('teacher.student.special-student.show',compact('specialStudent'));
    ...
    public function create(){
        return view('teacher.student.special-student.create');
    }
    ...
    public function store(Request $request){
        ...
        if( $save ){
            ...
            $userId = $user->id;  
            return redirect()->route('teacher.students.special-students.complete-create',$userId);        
    ...
    public function completeCreate($user_id){
        ...
        $studentClasses = StudentClass::where('type','special_student')
                                        ->where('branch_id', Auth::user()->branch->id)
                                        ->get();
        return view('teacher.student.special-student.complete-create',compact('user_id','studentClasses'));
    }
...
//store special_student
        ...
        if( $save ){     
            ...
            return redirect()->route('teacher.students.special-students.index')->with('success','Special Student Registered Successfully !');             
            }
        else{
            return redirect()->route('teacher.students.special-students.index')->with('fail','Something went Wrong, failed to complete register');
        }
    ...
    public function edit(SpecialStudent $specialStudent)
    {
        ...
        return view("teacher.student.special-student.edit",compact('specialStudent','studentClasses', 'classSections'));
    ...
    public function update(Request $request, SpecialStudent $specialStudent)
    {
        ...
        $photo = $request->photo;
                ...
                return redirect()->route('teacher.students.special-students.index')->with('success','Special Student Updated Successfully !'); 
