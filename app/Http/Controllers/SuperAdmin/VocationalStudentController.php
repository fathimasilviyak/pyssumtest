...
class VocationalStudentController extends Controller
{
    ...
    public function index(){
        ...
        $users = User::where('role', 'vocational_student')
         ...
         return view('super-admin.student.vocational-student.index',compact('users'));
    ...
    public function show(VocationalStudent $vocationalStudent){
        ...
        return view('super-admin.student.vocational-student.show',compact('vocationalStudent'));
    ...
    public function create(){
        return view('super-admin.student.vocational-student.create');
    }
    ...
    public function store(Request $request){
        ...
        if( $save ){
            ...
            $userId = $user->id;  
            return redirect()->route('super-admin.students.vocational-students.complete-create',$userId);        
    ...
    public function completeCreate($user_id){
        ...
        return view('super-admin.student.vocational-student.complete-create',compact('user_id'));
    }
...
//store vocational_student
        ...
        if( $save ){     
            ...
            return redirect()->route('super-admin.students.vocational-students.index')->with('success','Vocational Student Registered Successfully !');             
            }
        else{
            return redirect()->route('super-admin.students.vocational-students.index')->with('fail','Something went Wrong, failed to complete register');
        }
    ...
    public function edit(VocationalStudent $vocationalStudent)
    {
        ...
        return view("super-admin.student.vocational-student.edit",compact('vocationalStudent'));
    ...
    public function update(Request $request, VocationalStudent $vocationalStudent)
    {
        ...
        if($request->psychiatric_features){
            ...
            $psychiatricFeatures = false;
                ...
                return redirect()->route('super-admin.students.vocational-students.index')->with('success','Vocational Student Updated Successfully !'); 
