...
class SpecialStudentController extends Controller
{
    ...
    public function index(){
        ...
        $users = User::where('role', 'special_student')
         ...
         return view('super-admin.student.special-student.index',compact('users'));
    ...
    public function show(SpecialStudent $specialStudent){
        ...
        return view('super-admin.student.special-student.show',compact('specialStudent'));
    ...
    public function create(){
        return view('super-admin.student.special-student.create');
    }
    ...
    public function store(Request $request){
        ...
        if( $save ){
            ...
            $userId = $user->id;  
            return redirect()->route('super-admin.students.special-students.complete-create',$userId);        
    ...
    public function completeCreate($user_id){
        ...
        return view('super-admin.student.special-student.complete-create',compact('user_id', 'studentClasses'));
    }
...
//store special_student
        ...
        if( $save ){     
            ...
            return redirect()->route('super-admin.students.special-students.index')->with('success','Special Student Registered Successfully !');             
            }
        else{
            return redirect()->route('super-admin.students.special-students.index')->with('fail','Something went Wrong, failed to complete register');
        }
    ...
    {
        $studentClasses = StudentClass::where('type','special_student')->where('branch_id', session('branch'))->get();
        $classSections = ClassSection::where('student_class_id', $specialStudent->student_class_id)->get();
        return view("super-admin.student.special-student.edit",compact('specialStudent','studentClasses', 'classSections'));
    ...
    public function update(Request $request, SpecialStudent $specialStudent)
    {
        ...
        $photo = $request->photo;
                ...
                return redirect()->route('super-admin.students.special-students.index')->with('success','Special Student Updated Successfully !'); 
