...
class InclusiveStudentController extends Controller
{
    ...
    public function index(){
        ...
        $users = User::where('role', 'inclusive_student')
         ...
         return view('super-admin.student.inclusive-student.index',compact('users'));
    ...
    public function show(InclusiveStudent $inclusiveStudent){
        ...
        return view('super-admin.student.inclusive-student.show',compact('inclusiveStudent'));
    ...
    public function create(){
        return view('super-admin.student.inclusive-student.create');
    }
    ...
    public function store(Request $request){
        ...
        if( $save ){
            ...
            $userId = $user->id;  
            return redirect()->route('super-admin.students.inclusive-students.complete-create',$userId);        
    ...
    public function completeCreate($user_id){
        ...
        return view('super-admin.student.inclusive-student.complete-create',compact('user_id','studentClasses'));
    }
...
//store inclusive_student
        ...
        if( $save ){     
            ...
            return redirect()->route('super-admin.students.inclusive-students.index')->with('success','Inclusive Student Registered Successfully !');             
            }
        else{
            return redirect()->route('super-admin.students.inclusive-students.index')->with('fail','Something went Wrong, failed to complete register');
        }
    ...
    public function edit(InclusiveStudent $inclusiveStudent)
    {
        ...
        return view("super-admin.student.inclusive-student.edit",compact('inclusiveStudent','studentClasses', 'classSections'));
    ...
    public function update(Request $request, InclusiveStudent $inclusiveStudent)
    {
        ...
        $photo = $request->photo;
                ...
                return redirect()->route('super-admin.students.inclusive-students.index')->with('success','Inclusive Student Updated Successfully !'); 
