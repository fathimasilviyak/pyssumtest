...
class PDFController extends Controller
{
    ...
    public function generateSpecialStudentPDF(Request $request, SpecialStudent $specialStudent){
        ...
        $pdf = PDF::loadView('super-admin.student.special-student.pdf', compact('specialStudent','selectedData'));
    ...
    public function generateInclusiveStudentPDF(InclusiveStudent $inclusiveStudent){
        ...
        $pdf = PDF::loadView('super-admin.student.inclusive-student.pdf', compact('inclusiveStudent'));
    ...
    public function generateVocationalStudentPDF(VocationalStudent $vocationalStudent){
        ...
        $pdf = PDF::loadView('super-admin.student.vocational-student.pdf', compact('vocationalStudent'));
    ...
    public function generateTrainingStudentPDF(TrainingStudent $trainingStudent){
        ...
        $pdf = PDF::loadView('super-admin.student.training-student.pdf', compact('trainingStudent'));
    ...
    public function generateEIRegistrationPDF(EarlyInterventionRegistration $eIRegistration){
        ...
        $pdf = PDF::loadView('super-admin.early-intervention-registration.pdf', compact('eIRegistration'));
    ...
    public function generateFacultyPDF(Faculty $faculty){
        ...
        $pdf = PDF::loadView('super-admin.faculty.pdf', compact('faculty'));
