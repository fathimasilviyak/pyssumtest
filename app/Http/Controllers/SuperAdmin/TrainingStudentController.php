...
class TrainingStudentController extends Controller
{
    public function index(){
        ...
        $users = User::where('role', 'training_student')
         ...
         return view('super-admin.student.training-student.index',compact('users'));
    ...
    public function show(TrainingStudent $trainingStudent){
        ...
        return view('super-admin.student.training-student.show',compact('trainingStudent'));
    ...
    public function create(){
        return view('super-admin.student.training-student.create');
    }
    ...
    public function store(Request $request){
        ...
        if( $save ){
            ...
            $userId = $user->id;  
            return redirect()->route('super-admin.students.training-students.complete-create',$userId);        
    ...
    public function completeCreate($user_id){
        ...
        $studentClasses = StudentClass::where('type','training_student')
                                        ->where('branch_id', session('branch'))->get();
        return view('super-admin.student.training-student.complete-create',compact('user_id','studentClasses'));
    }
  ...
  //store training_student
          ...
          if( $save ){     
              ...
              return redirect()->route('super-admin.students.training-students.index')->with('success','Training Student Registered Successfully !');             
              }
          else{
              return redirect()->route('super-admin.students.training-students.index')->with('fail','Something went Wrong, failed to complete register');
          }
    ...
    public function edit(TrainingStudent $trainingStudent)
    {
        ...
        return view("super-admin.student.training-student.edit",compact('trainingStudent','studentClasses', 'classSections'));
    ...
    public function update(Request $request, TrainingStudent $trainingStudent)
    {
        ...
        $photo = $request->photo;
                ...
                return redirect()->route('super-admin.students.training-students.index')->with('success','Training Student Updated Successfully !'); 
