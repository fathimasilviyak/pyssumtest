...
class EarlyInterventionRegistrationController extends Controller
{
    ...
    public function index(){
        ...
        $eIRegistrations = EarlyInterventionRegistration::where('branch_id', Auth::user()->branch->id)
                                                            ->orderByDesc('id')->get();

         return view('admin.early-intervention-registration.index',compact('eIRegistrations'));
    ...
    public function show(EarlyInterventionRegistration $eIRegistration){
        ...
        return view('admin.early-intervention-registration.show',compact('eIRegistration'));
    ...
    public function create(){
        ...
        return view('admin.early-intervention-registration.create');
    }
  ...
  //store Early Intervention Registration
          ...
          $eIRegistration->branch_id = Auth::user()->branch->id;  
               
          $save = $eIRegistration->save();
  
          if( $save ){   
  
              return redirect()->route('admin.early-intervention-registrations.index')->with('success','Early Intervention Registration Done Successfully !');             
              }
          else{
              return redirect()->route('admin.early-intervention-registrations.index')->with('fail','Something went Wrong, failed to complete register');
          }
    ...
    public function edit(EarlyInterventionRegistration $eIRegistration)
    {
        ...
        return view("admin.early-intervention-registration.edit",compact('eIRegistration'));
    ...
    public function update(Request $request, EarlyInterventionRegistration $eIRegistration)
    {
        ...
        $photo = $request->photo;
                ...
                return redirect()->route('admin.early-intervention-registrations.index')->with('success','Early Intervention Registration Updated Successfully !'); 
