...
class ClassSectionController extends Controller
{
    ...
    public function index($studentClassId){
        ...
        $users = User::where('role', 'teacher')->where('branch_id', Auth::user()->branch->id)->get();
        return view('admin.student-class.class-section.index',compact('classSections','users','studentClassId'));
